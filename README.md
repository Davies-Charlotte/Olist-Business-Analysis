...
This analysis investigates Olist’s 2016-2018 marketplace data to identify key drivers of revenue growth, customer behaviour patterns, seller performance and operational challenges to provide recommendations that can improve revenue growth, operational efficiency and customer retention.
...
Between January 2017 and August 2018, Olist experienced significant revenue growth, with revenue increasing by an average of 14.2% month-on-month before stabilising in 2018. The marketplace’s reach also grew, with order volume increasing 15.7% monthly on average. Average order value (AOV) slightly declined, with an average of -0.6% per month, suggesting marketplace growth was driven more by an increase in transaction volume than an increase in spending amount. 
...
- **Revenue steadily increased throughout 2017**, reaching its peak of **£1.01M** in November 2017, suggesting overall strong marketplace growth. The marketplace’s growth followed a similar trend, with a month-on-month **revenue growth rate of +52%** in November, likely reflecting Black Friday and seasonal holiday spending.
...
- Customer demand is concentrated among a small number of product categories - **26% of the marketplace’s orders are from just three product categories**: Bed Bath Table, Health Beauty and Sports Leisure. These three product categories accounted for nearly **£3.3M in revenue** over the two-year period, **24% of the marketplace total.**
- The **ten most ordered product categories account for over 63% of all products sold** and culminate in a combined **revenue of nearly £8.2M**, contributing over **60% of the marketplace’s total revenue**.
- While Bed Bath Table and Health Beauty drive marketplace volume, higher-value categories such as Computers (**£1,098 average order value**) generate revenue through premium transactions rather than order frequency.
- At the other end of the marketplace, categories such as Security & Services, Fashion Children's Clothes and CDs/DVDs/Musicals contribute negligible amounts to marketplace revenue, each **less than 0.01% of total revenue**, and less than **0.01% of all products sold on the marketplace**. These categories therefore have both negligible revenue contribution and very limited customer demand.
...
- States SP, RJ and MG also currently represent the largest share of operational work, generating **41.98%, 12.92% and 11.70% of all marketplace orders** respectively, together contributing a **total of 66.60% of marketplace orders**. Order volume closely mirrors revenue ranking, suggesting that differences in revenue are driven primarily by customer demand than significantly higher customer spending. 
...
- From 99,441 total orders on the marketplace, **89.15% were delivered early, 1.30% were delivered on-time, and 6.57% of orders were delayed** and delivered later than their expected delivery time. Orders without a usable delivery outcome were excluded from this breakdown.
...
- 11,365 of the 98,673 reviews have a review score of 1/5, totalling **11.52% of all customer reviews**. 3,432 late deliveries have 1-star reviews from a total of 6,535 delayed deliveries, equating to **52.52%**. Delayed deliveries received a 1-star review rate approximately **4.6 times higher than the marketplace baseline**, indicating a strong association between delayed delivery and poor customer ratings.
...
- **The top 10% of sellers generate 67.49% of marketplace revenue**, indicating a relatively concentrated revenue distribution. However, **the top 10 individual sellers account for only 13.15%**, suggesting that revenue is distributed across a broader group of high-performing sellers rather than being dominated by a small handful of sellers and is less vulnerable to losing a single major revenue provider.
...
**Key takeaway:** Revenue is generated by a wider range of top-performing sellers rather than a small number of individual sellers, while slightly lower review scores among the highest-revenue sellers suggest that greater seller scale may translate into a less positive customer experience, highlighting an opportunity to strengthen seller performance as they grow.  
