...
After significant revenue growth in early 2017, the company’s sales continued to increase before reaching a more stable revenue level in 2018. Revenue and order volume displayed positive month-on-month growth: revenue increasing by +14.2% per month on average, order volume following closely with +15.7% per month on average. Average order value (AOV) slightly declined, with an average of -0.6% per month, suggesting marketplace growth was driven more by an increase in transaction volume than an increase in spending amount. 
...
- **Average order value generally declined during revenue growth**. Feb 2017, May 2017, and Nov 2017 all saw periods of revenue growth of **+105.6%, +40.6% and +52.1%** respectfully, however **AOV rates saw a decrease**, down **6.4%, 8.1% and 6.8%** respectively, suggesting that revenue growth was driven primarily by an increase in order volume than customer spending per order.
...
- States SP, RJ and MG also currently represent the largest share of operational work, generating **41.98%, 12.92% and 11.70% of all marketplace orders** respectively, together contributing a **total of 66.60% of marketplace orders**. Order volume closely mirrors revenue ranking, suggesting differences in revenue are driven primarily by customer demand than significantly higher AOV. 
